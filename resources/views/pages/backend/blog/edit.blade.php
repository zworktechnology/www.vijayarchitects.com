        ...
        <div class="page-content">
            <div class="container-fluid">
                <form autocomplete="off" method="POST"
                    action="{{ route('blog.update', ['unique_code' => $blog->unique_code]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-xxl-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="title">Master<span class="text-danger">
                                                        *</span></label>
                                                <select class="form-control" name="blog_master_id" id="blog_master_edit">
                                                    <option selected disabled>Select Master</option>
                                                    @foreach ($blog_masters as $blog_master)
                                                        <option value="{{ $blog_master->id }}"
                                                            @if (old('blog_master_id') == $blog_master->id) selected
                                                        @elseif (isset($blog) && $blog->blog_master_id == $blog_master->id)
                                                            selected @endif>
                                        ...
                                        <div class="col-xxl-8">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="title" placeholder="Title" spellcheck="true" name="title"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                id="textInput" placeholder="Slug-url" spellcheck="true" name="slug_url"
                                                value="{{ old('slug_url', $blog->slug_url) }}">
                                        </div>
                                        <div class="col-xxl-6">
                                            <div class="mb-3">
                                                <label for="image" class="form-label">Image<span>
                                                        <a href="{{ asset('assets/backend/blogimage/' . $blog->blog_image) }}"
                                        ...
                                        <div class="col-xxl-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="blog_img_alt"
                                                    value="{{ old('blog_img_alt', $blog->blog_img_alt) }}">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control @error('short_note') border border-danger @enderror" rows="3"
                                                spellcheck="true" name="short_note" id="short_note" placeholder="Short Note">{!! old('short_note', $blog->short_note) !!}</textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control @error('blog_content') border border-danger @enderror" rows="3"
                                                spellcheck="true" name="blog_content" id="myeditorinstance" placeholder="Blog">{!! old('blog_content', $blog->blog_content) !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="meta_title" spellcheck="true"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="meta_keyword" spellcheck="true"
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            spellcheck="true" value="{{ old('og_title', $blog->og_title) }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Description<span class="text-danger">
                                                *</span></label>
                                        <input type="text"
                                            ...
                                            spellcheck="true" value="{{ old('og_description', $blog->og_description) }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('writer_name', $blog->writer_name) }}">
                                    </div>
                                </div>
                            </div>
